...
SET @sql = 
  N'CREATE DATABASE [PracticaMaD_test] 
    ON PRIMARY ( NAME = PracticaMaD_test, FILENAME = "' + @Default_DB_Path + N'PracticaMaD_test_test.mdf")
    LOG ON ( NAME = PracticaMaD_test_log, FILENAME = "' + @Default_DB_Path + N'PracticaMaD_test_test_log.ldf")'
...
-- --------------------------------------------------
-- Date Created: 11/17/2023 20:13:15
-- Generated from EDMX file: C:\Users\dava\source\repos\practica-mad-mad01\Model\PracticaMaD.edmx
-- --------------------------------------------------
